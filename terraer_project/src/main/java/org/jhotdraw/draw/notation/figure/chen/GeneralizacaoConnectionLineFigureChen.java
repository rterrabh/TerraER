 ...
 */
public class GeneralizacaoConnectionLineFigureChen extends
	LabeledLineConnectionFigure {
	
	public GeneralizacaoConnectionLineFigureChen() {
		super();
	...
	public void read(DOMInput in) throws IOException {
		super.read(in);
		((TextFigure)this.getChild(0)).setText(in.getAttribute("labelGeneralizacaoText", "caracter�stica"));
	}
